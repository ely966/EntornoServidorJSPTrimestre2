...
public class UsuarioServiceDB implements UsuarioService {
	...
	@Override
		@PostConstruct
		public void init() {
			Usuario user1= new Usuario(1,"luis","luis","Luis Morales","Calle Mares n.6 piso:2A",654234187);
			
			Usuario user2=new Usuario(2,"maria","maria","Maria Rodriguez", "Avenida MariaFlores n.2 piso:4B",663123563);
