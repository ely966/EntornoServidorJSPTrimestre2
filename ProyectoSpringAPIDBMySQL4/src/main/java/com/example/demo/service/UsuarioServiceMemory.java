...
import com.example.DTO.UsuariosDTOConverter;
...
public List<UsuarioDTO> listarUsuarioSinPedidos (List<Usuario> usuariosNormal) {
	UsuariosDTOConverter userConverter = new UsuariosDTOConverter();
	List<UsuarioDTO> userDtos=userConverter.converteTo(usuariosNormal);
	return userDtos;
}
/**Obtener un usuario dto**/
public UsuarioDTO usuarioSinPedido (Usuario user) {
	UsuariosDTOConverter userConverter = new UsuariosDTOConverter();
	UsuarioDTO userDtos=userConverter.converteToOneUser(user);
	return userDtos;
}
